                            ...
                            void** pixels, int* pitch)
{
    ...
    *pixels = SDL_malloc(window->h*(*pitch));
    ...
    // why recreate with the same params?
                            ...
                            const SDL_Rect* rects, int numrects)
{
    ...
    MIR_mir_buffer_stream_get_graphics_region(mir_window->stream, &region);
    ...
    MIR_mir_buffer_stream_swap_buffers_sync(mir_window->stream);
